...
-- match 1031 annotations to 1002 annotations
...
and a._annot_key = e._annot_key
and e._annotevidence_key = p._annotevidence_key
and p._propertyterm_key = 13611348

-- match 1032 annotations to 1020 annotations
and p.value::int = mp._annot_key
and mp._annottype_key = 1020
and mp._object_key = ga._object_key
and ga._mgitype_key = 12
and ga._logicaldb_key = 1
and ga.preferred = 1
