...
def flatten (rows, fields):
        # flatten the rows into a single str. including the given 'fields'
        # from each
...
def compare (derivedAnnotations, sourceAnnotations):
        ...
        keys = list(derivedAnnotations.keys())
        keys.sort()
        ...
        for derivedKey in keys:
                ...
                if sourceKey not in sourceAnnotations:
